...
void __fastcall TForm4::displayFilters(String filterType, int arbitraryIdentifier)
{
	...
	int selectAllButtonX = selectAllButton->Position->X;
	int selectAllButtonY = selectAllButton->Position->Y;
	selectAllButton->Position->X = 20;
	selectAllButton->Position->Y = 20;

	//move roleListBox to upper left corner below select all button
	int RoleListBoxX = roleListBox->Position->X;
	int RoleListBoxY = roleListBox->Position->Y;
	roleListBox->Position->X = 20;
	roleListBox->Position->Y = 50;

	//move radio buttons to center left of screen
	int radioGroupBoxX = radioGroupBox->Position->X;
	int radioGroupBoxY = radioGroupBox->Position->Y;
	radioGroupBox->Position->X = 20;
	radioGroupBox->Position->Y = 280;
	/*int dayRadioX = dayRadio->Position->X;
	int dayRadioY = dayRadio->Position->Y;
	dayRadio->Position->X = 20;
	dayRadio->Position->Y = 280;
	int weekRadioX = weekRadio->Position->X;
	int weekRadioY = weekRadio->Position->Y;
	weekRadio->Position->X = 20;
	weekRadio->Position->Y = 310;
	int arbitraryRadioX = arbitraryRadio->Position->X;
	int arbitraryRadioY = arbitraryRadio->Position->Y;
	arbitraryRadio->Position->X = 20;
	arbitraryRadio->Position->Y = 340;
	int monthRadioX = monthRadio->Position->X;
	int monthRadioY = monthRadio->Position->Y;
	monthRadio->Position->X = 20;
	monthRadio->Position->Y = 370;
	int yearRadioX = yearRadio->Position->X;
	int yearRadioY = yearRadio->Position->Y;
	yearRadio->Position->X = 20;
